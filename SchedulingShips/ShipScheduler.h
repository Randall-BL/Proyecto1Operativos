...
uint8_t ship_scheduler_get_gate_left_state(const ShipScheduler *scheduler); // Obtiene estado puerta izquierda (0=abierta, 1=cerrando, 2=cerrada).
uint8_t ship_scheduler_get_gate_right_state(const ShipScheduler *scheduler); // Obtiene estado puerta derecha (0=abierta, 1=cerrando, 2=cerrada).
